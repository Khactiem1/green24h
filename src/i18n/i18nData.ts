...
export default {
  ...
  en: {
    ...
    i18nRole: i18nEnRole,
    i18nMenu: i18nEnMenu,
    i18nMenuFontend: i18nEnMenuFontend,
    i18nQuickLink: i18nEnQuickLink,
    i18nErrorReport: i18nEnErrorReport,
    i18nJobDefinition: i18nEnJobDefinition,
    i18nLanguage: i18nEnLanguage,
    i18nSystemConfig: i18nEnSystemConfig,
    i18nConfigNotify: i18nEnConfigNotify,
    i18nReceiveNotify: i18nEnReceiveNotify,
    i18nValidate: i18nEnValidate,
    i18nBanner: i18nEnBanner,
    i18nBank: i18nEnBank,
    i18nFooter: i18nEnFooter,
    i18nAnoucement: i18nEnAnoucement,
    i18nDictionaryList: i18nEnDictionaryList,
    i18nDictionary: i18nEnDictionary,
    i18nNews: i18nEnNews,
    i18nNewsList: i18nEnNewsList,
    i18nDepartment: i18nEnDepartment,
    i18nSupportList:i18nEnSupportList,
    i18nPosition:i18nEnPosition,
    i18nSupport: i18nEnSupport,
    i18nContact: i18nEnContact,
    i18nKeyword: i18nEnKeyword,
    i18nCompanyInfo: i18nEnCompanyInfo,
    i18nFunctionConfig: i18nEnFunctionConfig,
    i18nProvince: i18nEnProvince,
    i18nDistrict: i18nEnDistrict,
    i18nWard: i18nEnWard,
    i18nVoucherEvent: i18nEnVoucherEvent,
    i18nVoucher: i18nEnVoucher,
    i18nCategory: i18nEnCategory,
    i18nMemberType: i18nEnMemberType,
    i18nPaymentMethod: i18nEnPaymentMethod,
    i18nCustomer: i18nEnCustomer,
    i18nEmoticon: i18nEnEmoticon,
    i18nOrderHistory: i18nEnOrderHistory,
    i18nRecharge:i18nEnRecharge,
    i18nTransaction:i18nEnTransaction,
    i18nContractTemplate:i18nEnContractTemplate,
    i18nBrand:i18nEnBrand,
    i18nRegisterPackage: i18nEnRegisterPackage,
    i18nProductGroup: i18nEnProductGroup,
    i18nSupplier: i18nEnSupplier,
    i18nFeaturePackage: i18nEnFeaturePackage,
