    ...
    <div class="container-table">
        <div class="container-table_header border-line-bottom">
            <div class="name-table text-uppercase">
                <h1>{{ $t("i18nFunctionConfig.Title") }}</h1>
            </div>
        ...
        <ms-grid-viewer :ref="viewRef" :data="storeModule.items" :pageTotal="storeModule.total"
            :loading="storeModule.loading" :idField="'function_config_id'" :gridInfo="gridInfo" :loadData="loadData"
...
import useModuleFunctionConfig from "@/stores/system/moduleFunctionConfig";
import MenuItem from "@/components/dropdown/MenuItem.vue";
import MenuWrapper from "@/components/dropdown/MenuWrapper.vue";
import functionConfigAPI from "@/apis/system/functionConfigAPI";
...
export default defineComponent({
    ...
    setup: () => {
        ...
        const layoutTag = ref("FunctionConfigList"); // Cấu hình layout
        const formDetailName = ref("FunctionConfigDetail"); // Cấu hình tên form detail
