...
export default defineComponent({
  ...
  setup: () => {
    ...
    const layoutTag = ref("LanguageList"); // Cấu hình layout
    const formDetailName = ref("LanguageDetail"); // Cấu hình tên form detail
