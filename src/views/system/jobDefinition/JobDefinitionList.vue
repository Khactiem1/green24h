  ...
  <div class="container-table">
    <div class="container-table_header border-line-bottom">
      <div class="name-table text-uppercase">
        <h1>{{ $t("i18nJobDefinition.Title") }}</h1>
      </div>
...
import useModuleJobDefinition from "@/stores/system/moduleJobDefinition";
import MenuItem from "@/components/dropdown/MenuItem.vue";
import MenuWrapper from "@/components/dropdown/MenuWrapper.vue";
import jobDefinitionAPI from "@/apis/system/jobDefinitionAPI";
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const layoutTag = ref("JobDefinitionList"); // Cấu hình layout
    const formDetailName = ref("JobDefinitionDetail"); // Cấu hình tên form detail
