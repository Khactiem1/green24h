  ...
  <div class="container-table">
    <div class="container-table_header border-line-bottom">
      <div class="name-table text-uppercase">
        <h1>{{ $t("i18nDictionaryList.Title") }}</h1>
      </div>
...
import useModuleDictionaryList from "@/stores/system/moduleDictionaryList";
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const formDetailName = ref("DictionaryListDetail"); // Cấu hình tên form detail
    ...
    const column: any[] = [
      {
        lock: false,
        width: 250,
        header: "i18nDictionaryList.Detail.dictionary_list_code",
        dataField: "dictionary_list_code",
        formatType: 12,
        headerCustom: "",
        visible: true,
      },
      {
        lock: false,
        width: null,
        header: "i18nDictionaryList.Detail.dictionary_list_name",
