<template>
    <div class="container-table">
        ...
        <ms-grid-viewer :ref="viewRef" :data="storeModule.items" :pageTotal="storeModule.total"
            :loading="storeModule.loading" :idField="'keyword_id'" :gridInfo="gridInfo" :loadData="loadData"
...
export default defineComponent({
    ...
    setup: () => {
        ...
        const layoutTag = ref("KeywordList"); // Cấu hình layout
        const formDetailName = ref("KeywordDetail"); // Cấu hình tên form detail
