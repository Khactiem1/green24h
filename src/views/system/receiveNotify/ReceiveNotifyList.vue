  ...
  <div class="container-table">
    <div class="container-table_header border-line-bottom">
      <div class="name-table text-uppercase">
        <h1>{{ $t("i18nReceiveNotify.Title") }}</h1>
      </div>
...
import useModuleReceiveNotify from "@/stores/system/moduleReceiveNotify";
import MenuItem from "@/components/dropdown/MenuItem.vue";
import MenuWrapper from "@/components/dropdown/MenuWrapper.vue";
import receiveNotifyAPI from "@/apis/system/receiveNotifyAPI";
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const layoutTag = ref("ReceiveNotifyList"); // Cấu hình layout
    const formDetailName = ref("ReceiveNotifyDetail"); // Cấu hình tên form detail
