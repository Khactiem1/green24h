<template>
  <div class="container-table">
    ...
    <ms-grid-viewer :ref="viewRef" :data="storeModule.items" :pageTotal="storeModule.total"
      :loading="storeModule.loading" :idField="'footer_id'" :gridInfo="gridInfo" :loadData="loadData"
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const layoutTag = ref("FooterList"); // Cấu hình layout
    const formDetailName = ref("FooterDetail"); // Cấu hình tên form detail
