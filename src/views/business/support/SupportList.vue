<template>
  <div class="container-table">
    ...
    <ms-grid-viewer :ref="viewRef" :data="storeModule.items" :pageTotal="storeModule.total"
      :loading="storeModule.loading" :idField="'support_id'" :gridInfo="gridInfo" :loadData="loadData"
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const layoutTag = ref("SupportList"); // Cấu hình layout
    const formDetailName = ref("SupportDetail"); // Cấu hình tên form detail
