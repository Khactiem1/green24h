<template>
  ...
  import useModuleProvince from "@/stores/business/moduleProvince";
  ...
  export default defineComponent({
    ...
    setup: () => {
      ...
      const formDetailName = ref("ProvinceDetail"); // Cấu hình tên form detail
      ...
      const column: any[] = [
        {
          lock: false,
          width: null,
          header: "i18nProvince.Detail.province_name",
        ...
        },
        {
          lock: false,
          width: null,
          header: "i18nProvince.Detail.province_code",
