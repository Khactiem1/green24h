  ...
  <div class="container-table">
    <div class="container-table_header border-line-bottom">
      <div class="name-table text-uppercase">
        <h1>{{ $t("i18nPaymentMethod.Title") }}</h1>
      </div>
...
import useModulePaymentMethod from "@/stores/business/modulePaymentMethod";
import MenuItem from "@/components/dropdown/MenuItem.vue";
import MenuWrapper from "@/components/dropdown/MenuWrapper.vue";
import paymentMethodAPI from "@/apis/business/paymentMethodAPI";
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const layoutTag = ref("PaymentMethodList"); // Cấu hình layout
    const formDetailName = ref("PaymentMethodDetail"); // Cấu hình tên form detail
