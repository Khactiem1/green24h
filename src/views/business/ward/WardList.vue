<template>
    <div class="container-table">
        ...
        <ms-grid-viewer :ref="viewRef" :data="storeModule.items" :pageTotal="storeModule.total"
            :loading="storeModule.loading" :idField="'ward_id'" :gridInfo="gridInfo" :loadData="loadData"
...
import useModuleWard from "@/stores/business/moduleWard";
...
export default defineComponent({
    ...
    setup: () => {
        ...
        const layoutTag = ref("WardList"); // Cấu hình layout
        const formDetailName = ref("WardDetail"); // Cấu hình tên form detail
