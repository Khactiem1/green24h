<template>
  ...
  export default defineComponent({
    ...
    setup: () => {
      ...
      const formDetailName = ref("PositionDetail"); // Cấu hình tên form detail
      ...
      const column: any[] = [
        {
          lock: false,
          width: null,
          header: "i18nPosition.Detail.position_name",
