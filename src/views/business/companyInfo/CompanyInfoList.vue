<template>
  ...
  import useModuleCompanyInfo from "@/stores/business/moduleCompanyInfo";
  import MenuItem from "@/components/dropdown/MenuItem.vue";
  import MenuWrapper from "@/components/dropdown/MenuWrapper.vue";
  import companyInfoAPI from "@/apis/business/companyInfoAPI";
  ...
  export default defineComponent({
    ...
    setup: () => {
      ...
      const layoutTag = ref("CompanyInfoList"); // Cấu hình layout
      const formDetailName = ref("CompanyInfoDetail"); // Cấu hình tên form detail
