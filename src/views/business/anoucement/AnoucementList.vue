<template>
  <div class="container-table">
    ...
    <ms-grid-viewer :ref="viewRef" :data="storeModule.items" :pageTotal="storeModule.total"
      :loading="storeModule.loading" :idField="'anoucement_id'" :gridInfo="gridInfo" :loadData="loadData"
...
import useModuleAnoucement from "@/stores/business/moduleAnoucement";
import MenuItem from "@/components/dropdown/MenuItem.vue";
import MenuWrapper from "@/components/dropdown/MenuWrapper.vue";
import anoucementAPI from "@/apis/system/anoucementAPI";
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const layoutTag = ref("AnoucementList"); // Cấu hình layout
    const formDetailName = ref("AnoucementDetail"); // Cấu hình tên form detail
