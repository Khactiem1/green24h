<template>
    <div class="container-table">
        ...
        <ms-grid-viewer :ref="viewRef" :data="storeModule.items" :pageTotal="storeModule.total"
            :loading="storeModule.loading" :idField="'contact_id'" :gridInfo="gridInfo" :loadData="loadData"
...
export default defineComponent({
    ...
    setup: () => {
        ...
        const layoutTag = ref("ContactList"); // Cấu hình layout
        const formDetailName = ref("ContactDetail"); // Cấu hình tên form detail
