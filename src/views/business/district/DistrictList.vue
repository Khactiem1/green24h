<template>
    <div class="container-table">
        ...
        <ms-grid-viewer :ref="viewRef" :data="storeModule.items" :pageTotal="storeModule.total"
            :loading="storeModule.loading" :idField="'district_id'" :gridInfo="gridInfo" :loadData="loadData"
...
export default defineComponent({
    ...
    setup: () => {
        ...
        const layoutTag = ref("DistrictList"); // Cấu hình layout
        const formDetailName = ref("DistrictDetail"); // Cấu hình tên form detail
