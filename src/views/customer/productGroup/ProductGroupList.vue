    ...
    <div class="container-table">
        <div class="container-table_header border-line-bottom">
            <div class="name-table text-uppercase">
                <h1>{{ $t("i18nProductGroup.Title") }}</h1>
            </div>
        ...
        <ms-grid-viewer :ref="viewRef" :data="storeModule.items" :pageTotal="storeModule.total"
            :loading="storeModule.loading" :idField="'product_group_id'" :gridInfo="gridInfo" :loadData="loadData"
...
import useModuleProductGroup from "@/stores/customer/moduleProductGroup";
import MenuItem from "@/components/dropdown/MenuItem.vue";
import MenuWrapper from "@/components/dropdown/MenuWrapper.vue";
import productGroupAPI from "@/apis/customer/productGroupAPI";
...
export default defineComponent({
    ...
    setup: () => {
        ...
        const layoutTag = ref("ProductGroupList"); // Cấu hình layout
        const formDetailName = ref("ProductGroupDetail"); // Cấu hình tên form detail
