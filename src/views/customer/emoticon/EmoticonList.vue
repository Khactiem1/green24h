<template>
    <div class="container-table">
        ...
        <ms-grid-viewer :ref="viewRef" :data="storeModule.items" :pageTotal="storeModule.total"
            :loading="storeModule.loading" :idField="'emoticon_id'" :gridInfo="gridInfo" :loadData="loadData"
...
export default defineComponent({
    ...
    setup: () => {
        ...
        const layoutTag = ref("EmoticonList"); // Cấu hình layout
        const formDetailName = ref("EmoticonDetail"); // Cấu hình tên form detail
