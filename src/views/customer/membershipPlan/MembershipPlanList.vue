  ...
  <div class="container-table">
    <div class="container-table_header border-line-bottom">
      <div class="name-table text-uppercase">
        <h1>{{ $t("i18nMembershipPlan.Title") }}</h1>
      </div>
...
import useModuleMembershipPlan from "@/stores/customer/moduleMembershipPlan";
import MenuItem from "@/components/dropdown/MenuItem.vue";
import MenuWrapper from "@/components/dropdown/MenuWrapper.vue";
import membershipPlanAPI from "@/apis/customer/membershipPlanAPI";
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const layoutTag = ref("MembershipPlanList"); // Cấu hình layout
    const formDetailName = ref("MembershipPlanDetail"); // Cấu hình tên form detail
