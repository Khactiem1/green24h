                ...
                <div class="form-container pd-t-4">
                    <div class="form-detail flex">
                        <div class="form-item">
                            ...
                            <div class="form-group">
                                <ms-input :label="$t('i18nSupplier.Detail.phone')" v-model="model.phone"></ms-input>
                            </div>
                            <div class="form-group">
                                <ms-input :maxLength="50" :label="$t('i18nSupplier.Detail.email')"
                                    v-model="model.email"></ms-input>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="meta-content" style="flex: 1;">
                                    ...
                                    <div class="form-group" style="padding-left: 0;">
                                        <ms-combobox-v2 :label="$t('i18nSupplier.Detail.supplier_type')"
                                            ...
                                            @selected="selectedNewsType" :buildFilter="filterNewType" queryMode="remote"
        ...
        <template v-slot:footer="{ close }">
            <div class="form-action">
                <div class="form-action_container">
                    ...
                    <div class="form-action_item">
                        <ms-button @click="saveWithStatus(supplier_status.LuuTam)" class="mr-2">
                            {{ $t("i18nCommon.crud.save") }}
                        </ms-button>
                        <ms-button
                            v-if="model.supplier_type == supplier_status.LuuTam.supplier_status || model.supplier_type == supplier_status.TuChoi.supplier_status"
                            @click="saveWithStatus(supplier_status.ChoDuyet)" class="primary mr-2">
                            {{ $t('i18nSupplier.Detail.post_news') }}
                        </ms-button>
                        <ms-button v-if="model.supplier_type == supplier_status.ChoDuyet.supplier_status"
...
import useModuleSupplier from "@/stores/customer/moduleSupplier";
import supplierAPI from "@/apis/customer/supplierAPI";
...
import { useSupplierConfig } from "@/views/customer/supplier/supplierConfig"
import districtAPI from "@/apis/business/districtAPI";
import provinceAPI from "@/apis/business/provinceAPI";
import wardAPI from "@/apis/business/wardAPI";
    ...
    setup() {
        ...
        const beforeBindData = async () => {
            ...
            if (me.editMode == me.$ms.constant.FormState.Add) {
                ...
                me._formParam.dataRow.news_status = supplier_status.value.LuuTam.supplier_status;
                me._formParam.dataRow.news_status_name = supplier_status.value.LuuTam.supplier_status_name;
            }
        ...
        const beforeSave = async (model) => {
            ...
            //     model.supplier_type = newsStatusSave.value.news_status;
        ...
        const afterSaveSuccess = async (resultSave) => {
            const me: any = proxy;
            if (resultSave?.Data) {
                // me.model.supplier_type = resultSave.Data.news_status;
