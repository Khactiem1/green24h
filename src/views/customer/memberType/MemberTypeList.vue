<template>
  <div class="container-table">
    ...
    <ms-grid-viewer :ref="viewRef" :data="storeModule.items" :pageTotal="storeModule.total"
      :loading="storeModule.loading" :idField="'member_type_id'" :gridInfo="gridInfo" :loadData="loadData"
...
import useModuleMemberType from "@/stores/customer/moduleMemberType";
import MenuItem from "@/components/dropdown/MenuItem.vue";
import MenuWrapper from "@/components/dropdown/MenuWrapper.vue";
import memberTypeAPI from "@/apis/customer/memberTypeAPI";
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const layoutTag = ref("MemberTypeList"); // Cấu hình layout
    const formDetailName = ref("MemberTypeDetail"); // Cấu hình tên form detail
