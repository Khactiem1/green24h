      ...
      <div ref="slot-content" class="form-content-popup">
        <div class="form-container pd-t-4">
          ...
          <div class="form-detail flex">
            <div class="form-item">
              <div v-for="(lang, indexLang) in listLanguage()" :key="lang.tabKey">
                <div v-show="languageActive() == lang.tabKey">
                  <div class="form-group">
                    <ms-input
                      :maxLength="250"
                      :rules="indexLang == 0 ? [{ name: 'required' }, ] : []"
                      :label="$t('i18nNews.Detail.news_title')"
                      v-model="model[`news_title_${lang.language_code}`]"
                    ></ms-input>
                  </div>
                  <div class="form-group">
                    <ms-input
                      ...
                      v-model="model[`meta_keyword_${lang.language_code}`]"
                    ></ms-input>
                  </div>
                  <div class="form-group" style="padding-left: 0;">
                    <ms-input
                      ...
                      v-model="model[`meta_title_${lang.language_code}`]"
                    ></ms-input>
                  </div>
                  <div class="form-group">
                    <ms-textarea
                      ...
                      v-model="model[`news_desc_${lang.language_code}`]"
                    ></ms-textarea>
                  </div>
                </div>
              </div>
                ...
                <div class="meta-content" style="flex: 1;">
                  ...
                  <div class="form-group" style="padding-left: 0;">
                    <ms-combobox-v2
                      ...
                      :displayField="`news_list_name_${getLangDefault()}`"
                      :data="dataCombobox.news_list"
                      :initText="model[`news_list_name_${getLangDefault()}`]"
                      ...
                      v-model:display="model[`news_list_name_${getLangDefault()}`]"
                    ></ms-combobox-v2>
                  </div>
                  <div class="form-group" style="padding-left: 0;">
                    <ms-combobox-v2
          ...
          <div class="form-detail form-group">
            <div v-for="(lang, indexLang) in listLanguage()" :key="lang.tabKey">
              <div v-if="languageActive() == lang.tabKey">
                <ms-froala
                  :label="$t('i18nNews.Detail.content')"
                  v-model="model[`content_${lang.language_code}`]"
    ...
    <template v-slot:footer="{ close }">
      <div class="form-action">
        <div class="form-action_container">
          ...
          <div class="form-action_item">
            <ms-button 
              @click="saveWithStatus(news_status.LuuTam)" 
              class="mr-2"
...
export default defineComponent({
  ...
  setup() {
    ...
    const beforeSave = async (model) => {
      model.GetFormDataAfterSave = true;
