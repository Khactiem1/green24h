<template>
  <div class="container-table">
    ...
    <div class="table-function sticky">
      ...
      <div style="min-width: 720px" class="table-function_search">
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const listColumnsMultipleLanguage = ref(['news_list_name', 'news_desc', 'news_title', 'content', 'meta_title', 'meta_keyword']); // cấu danh sách các cột có đa ngôn ngữ để lấy tự động
    ...
    const loadDataNewsType = async () => {
      ...
      const payload = {
        ...
        PageSize: 0,
        Columns: "*",
        Filter: JSON.stringify(["dictionary_list_code", "=", "LoaiTin"]),
        Sort: "",
        CustomParam: {},
      };
      me.$ms.commonFn.mask();
