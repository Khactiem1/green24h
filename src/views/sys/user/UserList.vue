          ...
          >
            ...
            >
              ...
              <div
                class="list_action-item"
                v-if="checkActionPermission('Edit')"
                @click="resetPassword(gridInfo.selected)"
              >
                <font-awesome-icon :icon="['fas', 'key']" class="mr-2" />
                {{ $t("i18nUser.ResetPassword") }}
              </div>
            </div>
          </button>
          ...
          >
            ...
            <template #menu-content>
              ...
              <menu-item
                v-if="checkActionPermission('Edit')"
                class="menu-item-feture my-1 text-color-primary hover-primary"
                @menu-item-click="changePassword(record)"
              >
                <font-awesome-icon :icon="['fas', 'key']" class="mr-2" />
                <span>{{ $t("i18nCommon.ChangePass") }}</span>
              </menu-item>
              <menu-item
                v-if="checkActionPermission('Edit')"
                class="menu-item-feture my-1 text-color-primary hover-primary"
                @menu-item-click="resetPassword([record])"
              >
                <font-awesome-icon :icon="['fas', 'key']" class="mr-2" />
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const changePassword = (user: any) => {
      popupUtil.show("ChangePassword", user);
    };
